...
class CommunicationPage extends StatefulWidget {
  ...
  const CommunicationPage({Key? key, required this.userFrom, required this.userTo})
      : super(key: key);
...
class _CommunicationPageState extends State<CommunicationPage> {
  final List<Map<String, dynamic>> communicationItems = [
    {
      "title": "Phones",
      "key": "phones",
  ...
  void _onCardClicked(Map<String, dynamic> item) async {
    ...
    try {
      ...
      if (stateFromObj != null && stateFromObj['communication'] is Map) {
        final communicationFrom = Map<String, dynamic>.from(stateFromObj['communication']);
        if (communicationFrom[key] is List) contentFrom = List<String>.from(communicationFrom[key]);
      }

      if (stateToObj != null && stateToObj['communication'] is Map) {
        final communicationTo = Map<String, dynamic>.from(stateToObj['communication']);
        if (communicationTo[key] is List) contentTo = List<String>.from(communicationTo[key]);
      }
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => _CommunicationComparisonPage(
            title: item['title'],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const TranslatedText("📡 Communication"),
        actions: [
          IconButton(
        ...
        children: [
          Padding(
            ...
            child: Autocomplete<String>(
              ...
              onSelected: (selected) {
                final match = communicationItems.firstWhere((e) => e['title'] == selected);
              ...
              fieldViewBuilder: (context, textEditingController, focusNode, onFieldSubmitted) {
                return TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Search Communication Topics...',
                  ...
                  onSubmitted: (v) {
                    final match = communicationItems.firstWhere(
          ...
          Expanded(
            child: GridView.count(
              ...
              mainAxisSpacing: 16,
              crossAxisSpacing: 16,
              children: communicationItems.map((item) => _buildCommunicationCard(item)).toList(),
            ),
          ),
        ],
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(item['icon'], size: 90, color: Colors.blue),
...
class _CommunicationComparisonPage extends StatelessWidget {
  final String title;
  ...
  const _CommunicationComparisonPage({
    super.key,
    required this.title,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: maxLength == 0
          ? Center(
              child: TranslatedText(
                'No communication information available for this category.',
